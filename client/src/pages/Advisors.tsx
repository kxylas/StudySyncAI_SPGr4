              ...
              <div className="bg-neutral-700 p-4 rounded-lg">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="p-2 bg-neutral-600 rounded flex justify-between">
                    <span className="text-gray-300">Apr 5, 10:00 AM</span>
                    <span className="text-[#F5A623]">Dr. Wang</span>
                  </li>
                  <li className="p-2 bg-neutral-600 rounded flex justify-between">
                    <span className="text-gray-300">Apr 6, 1:30 PM</span>
                    <span className="text-[#F5A623]">Dr. Rahman</span>
                  </li>
                  <li className="p-2 bg-neutral-600 rounded flex justify-between">
                    <span className="text-gray-300">Apr 7, 11:00 AM</span>
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm mb-3">{advisor.title}</p>
                    ...
                    <CardContent className="pt-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm mb-3">{staff.title}</p>
            ...
            <CardContent>
              ...
              <ul className="space-y-3">
                <li className="bg-neutral-700 p-3 rounded-lg">
                  ...
                  <p className="text-gray-400 text-sm mb-2">Contact your adviser to submit request. Contact Ms. Wendy for updates.</p>
                </li>
                <li className="bg-neutral-700 p-3 rounded-lg">
                  <h3 className="text-[#F5A623] font-medium mb-1">COSC Internal Course Substitution Requests</h3>
                  <p className="text-gray-400 text-sm mb-2">Contact your adviser to submit the request for you. Contact Ms. Wendy for updates.</p>
                  <p className="text-gray-400 text-sm">Core courses cannot be substituted. Requests for approvals are not always granted.</p>
                </li>
                <li className="bg-neutral-700 p-3 rounded-lg">
                  <h3 className="text-[#F5A623] font-medium mb-1">COSC Adviser/Faculty Recommendation Request Form</h3>
                  <p className="text-gray-400 text-sm">Contact Ms. Wendy for assistance.</p>
                </li>
                <li className="bg-neutral-700 p-3 rounded-lg">
